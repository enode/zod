...
export declare type ZodDiscriminatedUnionObject<Discriminator extends string> = ZodObject<{
    [key in Discriminator]: ZodTypeAny;
} & ZodRawShape, any, any>;
export declare type ZodDiscriminatedUnionOption<Discriminator extends string> = ZodDiscriminatedUnionObject<Discriminator> | ZodDiscriminatedUnion<string, Array<ZodDiscriminatedUnionOption<string>>>;
export interface ZodDiscriminatedUnionDef<Discriminator extends string, Options extends Array<ZodDiscriminatedUnionOption<string>> = Array<ZodDiscriminatedUnionOption<string>>> extends ZodTypeDef {
    discriminator: Discriminator;
    options: Options;
    optionsMap: Map<Primitive, ZodDiscriminatedUnionOption<Discriminator>>;
    typeName: ZodFirstPartyTypeKind.ZodDiscriminatedUnion;
}
export declare class ZodDiscriminatedUnion<Discriminator extends string, Options extends Array<ZodDiscriminatedUnionOption<string>>> extends ZodType<output<Options[number]>, ZodDiscriminatedUnionDef<Discriminator, Options>, input<Options[number]>> {
    _parse(input: ParseInput): ParseReturnType<this["_output"]>;
    get discriminator(): Discriminator;
    get options(): Options;
    get optionsMap(): Map<Primitive, ZodDiscriminatedUnionOption<Discriminator>>;
    _enforceParentDiscriminator(discriminator: string): Primitive[];
    /**
